        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-lg-6 col-md-6 row justify-content-center align-items-center">
                <div class="mt-5 mt-lg-0">
                    <h2 class="py-3">Emprego</h3>
                    <p class="fs-4">Tens algum conhecimento na área académica, podes trabalhar de forma independente na plataforma LMTeacher. Basta só, registar-se como especialista e já está, o seu primeiro emprego e de forma independente.</p>
                </div>
                <div class="my-1">
                    <div class="nav-item">
                        <a id="turnEspec" class="fs-5" role="button"><small>Tornar-me um especialista.</small></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-0 col-lg-6 col-md-6 divImgContact">
                <img class="img img-fluid" src="{{ asset('img/hiring.svg') }}" alt="Mo">
            </div>
        </div>
    </div>
</div>
